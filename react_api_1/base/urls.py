...
from .views import get_nmap,get_meta,get_scan,get_host,get_meta_host,get_meta_service,get_meta_vulnerability,get_meta_scan,check_login,add_user,send_csv,send_users,get_nmap_by_id,update_scan,add_Scan,delete_scan,get_meta_id,update_meta_id,delete_meta_id,VA_chartAPI, asset_summary,addMeta 
...
urlpatterns = [
    ...
    path('scanDelete/<int:id>/',delete_scan,name="delete_scan"),
